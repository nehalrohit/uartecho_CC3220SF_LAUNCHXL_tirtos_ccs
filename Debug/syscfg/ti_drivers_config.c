...
const uint_least8_t Alert_GPIO_CONST = Alert_GPIO;
const uint_least8_t CONFIG_GPIO_ss_CONST = CONFIG_GPIO_ss;
const uint_least8_t CONFIG_IN2_CONST = CONFIG_IN2;
const uint_least8_t CONFIG_GPIO_nsleep_CONST = CONFIG_GPIO_nsleep;
const uint_least8_t CONFIG_GPIO_fault_CONST = CONFIG_GPIO_fault;
...
const PWM_Config PWM_config[CONFIG_PWM_COUNT] = {
    ...
    {
        .fxnTablePtr = &PWMTimerCC32XX_fxnTable,
        .object = &pwmTimerCC32XXObjects[CONFIG_PWM_Buzzer],
        .hwAttrs = &pwmTimerCC32XXHWAttrs[CONFIG_PWM_Buzzer]
    },
};
...
static unsigned char uartCC32XXRingBuffer0[64];
