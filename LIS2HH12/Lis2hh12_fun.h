...
#ifndef LIS2HH12_LIS2HH12_FUN_H_
#define LIS2HH12_LIS2HH12_FUN_H_

#include <i2c.h>

/*************************** REGISTER MAP ***************************/
#define LIS2HH12_I2C_ADD_L 0x1D
...
#define ONDHPF 18
   ...
   *  is to set the decrement function.
   *  @param IG
   *  @param Status
   ...
   *  You need to select which interrupt generator is to set the wait
   *  function.
   *  @param IG
   *  @param Status
   *  There are two specific macros to IG (IG1 and IG2) two generic to
   ...
   * need to select which interrupt generator is to set the latched function.
   *  @param Status
   *  @param IG
   *  There are two specific macros to IG (IG1 and IG2) two generic to
   *  Status (LIS_DISABLED and LIS_ENABLE)
...
int32_t platform_read(uint8_t reg_addr, uint8_t *reg_data, uint16_t len);
int32_t platform_write(uint8_t reg_addr, uint8_t *reg_data, uint16_t len);

#endif /* LIS2HH12_LIS2HH12_FUN_H_ */
